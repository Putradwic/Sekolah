...
if (isset($_GET['kodejurusan'])) {
  ...
  if (!$data) {
      $pesan = "Data jurusan dengan kode {$kodejurusan} tidak ditemukan!";
      $tipe_pesan = 'danger';
  }
} else {
  $pesan = "Parameter kodejurusan tidak ditemukan!";
  $tipe_pesan = 'danger';
  $data = null;
}
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Edit Jurusan</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-info card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Form Edit Jurusan</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input
                            ...
                            value="<?= htmlspecialchars($data['namajurusan'] ?? '') ?>"
                            maxlength="60"
                            name="namajurusan"
                            required
                          />
