<?php
include 'koneksi.php';
$db = new database(); // asumsinya class-nya udah ada

if (isset($_GET['kodeagama'])) {
  $kodeagama = $_GET['kodeagama'];

  $data = $db->getAgamaByKode($kodeagama);

  if (!$data) {
      $pesan = "Data agama dengan kode {$kodeagama} tidak ditemukan!";
      $tipe_pesan = 'danger';
  }
} else {
  $pesan = "Parameter kodeagama tidak ditemukan!";
  $tipe_pesan = 'danger';
  $data = null;
}
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['simpan'])) {
    ...
    $result = $db->updateagama($kodeagama, $_POST);

    if ($result) {
        $pesan = "Data agama berhasil diperbarui!";
        $tipe_pesan = 'success';
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Edit Agama</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-info card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Form Edit Agama</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form class="needs-validation" method="post" novalidate>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="hidden" name="kodeagama" value="<?= htmlspecialchars($data['kodeagama'] ?? '') ?>">
                    ...
                    <div class="card-footer">
                        <button href="datasiswa.php" class="btn btn-primary" type="submit" name="simpan">Simpan</button>
                      ...
                      <div class="modal-content border-<?= $tipe_pesan ?>">
                          ...
                          <div class="modal-footer">
                              <button class="btn btn-outline-<?= $tipe_pesan ?>" 
                                      onclick="location.href='<?= $tipe_pesan === 'success' ? 'dataagama.php' : 'editagama.php?kodejurusan=' . (isset($kodeagama) ? $kodeagama : '') ?>'">
                                  Tutup
                              </button>
                          </div>
                    </div>
