...
<html lang="en">
  ...
  <link rel="icon" type="image/png" href="dist/assets/img/image.png" />
    ...
    <meta name="title" content="AdminLTE 4 |  Elements" />
            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-info card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Form Edit Guru</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form class="needs-validation" id="formGuru" method="post" novalidate>
                    <div class="card-body">
                      ...
                      <div class="col-md-6">
                        ...
                        <select name="agama" class="form-select" id="validationCustom04" required>
                        <?php
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" name="nip" id="validationCustom02" maxlength="18" pattern="[0-9]*" required value="<?= htmlspecialchars($data['nip']); ?>"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="validationCustom05" name="golongan" required>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                $selected = ($row['kodegolongan'] == $data['kodegolongan']) ? "selected" : "";
                                echo "<option value='{$row['kodegolongan']}' $selected>{$row['golongan']}</option>";
                            }
                            ?>
                          </select>
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="validationCustom03" name="jeniskelamin" required>
                            <option disabled <?= empty($data['jeniskelamin']) ? 'selected' : '' ?>>Pilih jenis kelamin...</option>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="tel" class="form-control" id="validationCustom06" pattern="[0-9]{10,13}" required name="nohp" placeholder="081234567890" maxlength="13" value="<?= htmlspecialchars($data['nohp']); ?>"/>
                        ...
                        <input type="hidden" name="idguru" value="<?= htmlspecialchars($data['idguru']) ?>">
                      </div>
                    </div>
